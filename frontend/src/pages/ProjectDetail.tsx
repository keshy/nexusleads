                ...
                <div className="flex items-center justify-end mt-4">
                  <div className="relative" ref={actionDropdownId === src.id ? actionDropdownRef : undefined}>
                    ...
                    {actionDropdownId === src.id && (
                      <div className="absolute z-30 top-full mt-1 right-0 min-w-[220px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl overflow-hidden">
                        <button
