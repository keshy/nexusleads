...
MANAGED_SETTINGS = [
    ...
    },
    {
        ...
        "description": "Discord bot token for scanning server members and activity.",
        "is_secret": True,
        "hint": "Create a bot at discord.com/developers/applications. Enable SERVER MEMBERS INTENT and MESSAGE CONTENT INTENT in the Bot settings.",
        "help_url": "https://discord.com/developers/applications",
        "required": False,
        "placeholder": "MTxxxxxxxxxxxxxxxxxxxxxxxx.xxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxx",
    },
    {
        "key": "REDDIT_CLIENT_ID",
        "description": "Reddit OAuth2 application client ID for scanning subreddit participants.",
        "is_secret": False,
        "hint": "Create a 'script' type app at reddit.com/prefs/apps. The client ID is the short string under the app name.",
    ...
    },
    {
        ...
        "description": "Reddit OAuth2 application client secret.",
        "is_secret": True,
        "hint": "Found in your Reddit app settings alongside the client ID.",
        "help_url": "https://www.reddit.com/prefs/apps",
        "required": False,
    ...
    {
        "key": "X_BEARER_TOKEN",
        "description": "X (Twitter) API v2 Bearer Token for scanning followers and engagers.",
        "is_secret": True,
        "hint": "Create a project at developer.twitter.com. Generate a Bearer Token under Keys and Tokens.",
        "help_url": "https://developer.twitter.com/en/portal/dashboard",
        "required": False,
        "placeholder": "AAAAAAAAAAAAAAAAAAAAAxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
    },
    {
        "key": "STOCKTWITS_TOKEN",
        "description": "StockTwits access token for higher rate limits when scanning ticker streams.",
        "is_secret": True,
        "hint": "Optional — the StockTwits API works without a token at lower rate limits. Get a token at stocktwits.com/developers.",
        "help_url": "https://stocktwits.com/developers",
        "required": False,
